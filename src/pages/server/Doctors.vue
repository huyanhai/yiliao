<template>
  <div>
    ...
    <my-table :data-source="list" :pagination="pagination" @change="onPageChange">
      ...
      <a-table-column key="titleType" title="医生职称" data-index="lastName" />
      <a-table-column key="hospitalName" title="所属医院" data-index="lastName" />
      <a-table-column key="departmentId1" title="所属科室" data-index="lastName" />
