<template>
  <div>
    ...
    <my-table :data-source="[1]" :pagination="pagination" @change="onPageChange">
      ...
      <a-table-column key="name" title="设备名称" data-index="lastName" />
      <a-table-column key="name" title="设备编号" data-index="lastName" />
      <a-table-column key="name" title="所属医院" data-index="lastName" />
      <a-table-column key="name" title="设备Mac" data-index="lastName" />
      <a-table-column key="name" title="设备类型" data-index="lastName" />
      <a-table-column key="name" title="设备状态" data-index="lastName" />
